...
value_function_bellman = evaluate_policy_bellman(np.zeros_like(rewards_field), rewards_field, policy_from_image, discount)
plot_environment(value_function_bellman, n_width, n_height, annotate=True)